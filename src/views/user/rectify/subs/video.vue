...
import { DiagnosFileService } from "src/services";
import { service } from "src/common/decorator";
import dayjs from "dayjs";
import { imagePath } from "src/common/utils/extend-utils";

@component
export default class StaffVideoView extends View
{
    @service("DiagnosFileService")
    protected diagnosFileService: DiagnosFileService;
    ...
    {
        let { content } = await this.diagnosFileService.list({data: {diagnosisDeptId: this.detail.id, ...this.filters}});
