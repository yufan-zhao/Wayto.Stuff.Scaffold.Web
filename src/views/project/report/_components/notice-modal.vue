        ...
        <template v-slot:content>
            <i-form class="customed-form" ref="form" :model="formModel" :rules="rules">
                <i-row type="flex" justify="start">
                    <i-col span="24">
                        <i-form-item prop="projectEvaluation" class="customed-form-item" label="项目评价" :label-width="120">
                            <i-input type="textarea" v-model="formModel.projectEvaluation" placeholder="请输入"></i-input>
                        </i-form-item>
                    </i-col>
                </i-row>
            </i-form>
 ...
 */
@component
export default class NoticeModal extends View
{
    ...
    protected rules: any =
    {
        projectEvaluation: [{required: true,message: "请输入项目评价，如无意见则填写'无'"}]
    };
