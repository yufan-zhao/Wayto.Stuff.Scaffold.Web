            ...
            <i-form class="u-form" label-position="left" style="width: 100%">
                <i-row type="flex" justify="start">
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="购入日期 ">{{detail.buyDate  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="发票号">{{detail.invoiceNumber  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="报销凭证号">{{detail.reimbursementNumber  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="购买原值（元） ">{{detail.buyOriginalPrince  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="设备状态">{{detail.deviceStatus ? "可用" : "不可用"  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="设备管理员">{{detail.deviceAdministratorName   || "-"}}</i-form-item>
                    </i-col>
                    
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="存放地点">{{detail.storageLocationName  || "-"}}</i-form-item>
                    </i-col>
                    <i-col class-name="u-col" span="8">
                        <i-form-item class="u-form-item" label="数量">{{detail.amount  || "-"}}</i-form-item>
                    </i-col>
