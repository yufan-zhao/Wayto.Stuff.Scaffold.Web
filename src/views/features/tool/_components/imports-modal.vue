...
export default class ImportModal extends View
{
    ...
    public onFileDownload(link: string)
    {
        ...
        FileUtils.downloadFile(ApplicationContext.current.settings.mainOriginUrl + ApplicationContext.current.settings.mainPrefix + "/tools/instruments/downloadToolsTemplate","工器具导入模板");
