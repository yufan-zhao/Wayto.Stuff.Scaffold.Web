<template>
    <u-crud-modal
        ...
        :title="mode === 'insert' ? '添加危大工程类型' : '修改危大工程类型'"
        @on-ops="onOps"
        @on-closed="onClosed"
    >
 ...
 */
@component
export default class SpecialRuleEpicDangerTypeModal extends CommonView
{
    /**
     * 新增接口
     * @protected
     ...
     * @member
     */
    public open(mode: string, specialTypeId: number, data: any)
    {
