<template>
    <div class="safety-knowledge-view">
        <div class="header">
            <div class="left"></div>
            <div class="right">
...
import SafetyKnowledgeTable from "src/views/_components/safety-knowledge-table.vue";
...
export default class SafetyKnowledgeView extends View
{
    /**
     * 诊治详情
     * @config
