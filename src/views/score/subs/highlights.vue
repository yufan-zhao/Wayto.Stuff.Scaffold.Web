<template>
    <div class="highlights-view">
        ...
        <main-modal ref="mainModal" :consultDetail="consultDetail" :logoUrl="logoUrl" @on-refresh="initData"></main-modal>
...
@component({
    components:
    {
        "main-modal": HighlightsModal
    }
})
export default class HighlightsView extends View
{
    @service("ScoreHighlightsService")
    private mainService: ScoreHighlightsService;
