        ...
        <template v-slot:content>
            <i-form class="customed-form" ref="form" :model="formModel" :rules="rules">
                <i-row type="flex" justify="start">
                    ...
                    <i-col span="24">
                        <i-form-item class="customed-form-item" label="情况描述：" :label-width="120">
...
import { ScoreHighlightsService, CommonFileService, DictService } from "src/services";
...
export default class InsertUpdateModal extends View
{
    ...
    private mianService: ScoreHighlightsService;
