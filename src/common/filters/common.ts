 ...
 * @param url 图片url
 */
export function urlTimetamp(url: any): string
{
 ...
 * @param url 图片url
 */
export function imagePath(url: string, type?: string): string
{
...
export function numberRound(digit: number, length: any)
{
 ...
 * @requires string
 */
export function enumText(value: number, enums: any): string
{
 ...
 * @requires string
 */
export function enumAlias(value: number, enums: any): string
{
 ...
 * @requires string
 */
export function enumDescription(value: number, enums: any): any
{
    return typeof value === "number" && EnumUtils.getEntry(value, enums) ? EnumUtils.getEntry(value, enums).description : {};
}
 ...
 * @requires any
 */
export function tooltipElement(value: any, lengths: any, h: any, maxWidth: any, ele = "div", className = ""): any
{
    let nameDiv = null;
