...
@Injectable()
export default class SpecialCustomRuleInfo extends ServiceBase
{
    @httpConfig({method: "GET",url: "/specialCustomRuleInfo/pageDetails", schema: "/serverApi"})
    ...
    @httpConfig({method: "GET",url: "/specialCustomRuleInfo/listDetails", schema: "/serverApi"})
     ...
     * @returns 
     */
    @httpConfig({method: "GET",url: "/specialCustomRuleInfo/getDangerStats", schema: "/serverApi"})
     ...
     * @returns 
     */
    @httpConfig({method: "GET",url: "/specialCustomRuleInfo/getDangerTree", schema: "/serverApi"})
    ...
    @httpConfig({method: "GET",url: "/specialCustomRuleInfo/getDetailById", schema: "/serverApi"})
     ...
     * @returns 
     */
    @httpConfig({method: "POST", url: "/specialCustomRuleInfo/save", schema: "/serverApi"})
     ...
     * @returns 
     */
    @httpConfig({method: "PUT", url: "/specialCustomRuleInfo/updateById", schema: "/serverApi"})
     ...
     * @returns 
     */
    @httpConfig({method: "PUT", url: "/specialCustomRuleInfo/virtualRemoveById", schema: "/serverApi"})
